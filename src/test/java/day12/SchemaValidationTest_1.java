...
public class SchemaValidationTest_1 {
    ...
    public void testSearchSpartansSchema(){
        ...
        // search female query in param and validate response against schema
        given()
    ...
    because it only look for schema under resources folder.
    ...
    public void testAllSpartansSchemaInRootPath(){
        ...
        // use matchesJasonSchema method that accept a file
        // do your validation

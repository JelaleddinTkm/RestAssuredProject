...
public class Practice1_3 {
    ...
    public void test1(){
        ...
        Response response = get("http://3.85.141.124:8000/api/hello") ;
    ...
    public void testHello(){
        ...
        // response.header("Content-length") give us a string result so we need to do string comparsion
...
//        System.out.println( response.getBody().toString()  );
    ...
    public void printingBody(){
        ...
        /*
            ...
            Content-Length: 17
            Date: Tue, 18 Aug 2020 18:37:32 GMT
...
Content-Type: text/plain;charset=UTF-8
Content-Length: 17
Date: Tue, 18 Aug 2020 18:44:03 GMT

...
public class RestAssuredMethodChaining_5 {
...
//       then()
        ...
        when().
                get("http://3.85.141.124:8000/api/hello").  // sending a request to ths url
    ...
    public void testAllSpartans(){
        ...
        // then part -- ValidatableResponse
                ...
                // if any assertions fail , whole test fails
        ...
        when().
                get("http://3.85.141.124:8000/api/spartans").
                prettyPeek().
